            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="/admin/index.html">
                        <img class="object-cover" src="/admin/pictures/digikala-logo-freelogovectors.net_.png" class="" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="index.html" class="nav-link"> دیجی کالا </a>
                </li>
            </ul>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown language-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="/admin/assets/img/de.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;آلمانی</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="/admin/assets/img/jp.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;ژاپنی</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="/admin/assets/img/fr.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;فرانسوی</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="/admin/assets/img/ca.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;انگلیسی</span></a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="">
                            <div class="dropdown-item">
                                <a href="#">{{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->name }}</a>
                            </div>
                            <div class="dropdown-item">
                                <a href="#">
