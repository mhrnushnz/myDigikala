    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                @role('order admin|super admin|product admin')
                    <li class="menu">
                    <a href="{{ route('admin.dashboard.index') }}" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                        <div class="">
                ...
                @role('super admin|product admin')
                    <li class="menu">
                ...
                @role('order admin|super admin|product admin')
                    ...
                    <ul class="collapse submenu list-unstyled" id="app2" data-parent="#accordionExample">
                        <li>
                            <a href="{{ route('admin.order.index') }}?status=all"> همه سفارشات </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.order.index') }}?status=pending">  pending </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.order.index') }}?status=processing"> processing </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.order.index') }}?status=completed"> completed  </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.order.index') }}?status=cancel"> cancel </a>
                        </li>
                    </ul>
                </li>
                @endrole
                ...
                @role('order admin|super admin')
                <li class="menu">
                    <a href="#app3" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cpu"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect><rect x="9" y="9" width="6" height="6"></rect><line x1="9" y1="1" x2="9" y2="4"></line><line x1="15" y1="1" x2="15" y2="4"></line><line x1="9" y1="20" x2="9" y2="23"></line><line x1="15" y1="20" x2="15" y2="23"></line><line x1="20" y1="9" x2="23" y2="9"></line><line x1="20" y1="14" x2="23" y2="14"></line><line x1="1" y1="9" x2="4" y2="9"></line><line x1="1" y1="14" x2="4" y2="14"></line></svg>
                            <span>تراکنش ها</span>
                        </div>
                    ...
                    <ul class="collapse submenu list-unstyled" id="app3" data-parent="#accordionExample">
                        <li>
                            <a href="{{ route('admin.transaction.index') }}?status=all"> همه تراکنش ها </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.transaction.index') }}?status=completed"> موفق </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.transaction.index') }}?status=completed"> ناموفق </a>
                        </li>
                    </ul>
                </li>
                @endrole
